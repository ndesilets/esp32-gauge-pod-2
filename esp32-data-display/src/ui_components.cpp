...
framed_panel_t framed_panel_create(lv_obj_t* parent, const char* title,
  ...
  lv_obj_set_flex_align(out.body, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER,
                        LV_FLEX_ALIGN_START);
  ...
  lv_obj_set_flex_align(minmax_container, LV_FLEX_ALIGN_SPACE_BETWEEN,
...
simple_metric_t simple_metric_create(lv_obj_t* parent, const char* title,
  ...
  lv_obj_set_flex_align(out.container, LV_FLEX_ALIGN_START,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
  ...
  lv_obj_set_flex_align(vals_container, LV_FLEX_ALIGN_CENTER,
                        LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START);
