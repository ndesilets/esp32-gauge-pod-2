 ...
 */
#define ESP_PANEL_BOARD_NAME                "Waveshare:ESP32-S3-3.49-Touch-LCD"

/**
 * @brief Panel resolution configuration in pixels
 */
#define ESP_PANEL_BOARD_WIDTH               (640)   // Panel width (horizontal, in pixels)
#define ESP_PANEL_BOARD_HEIGHT              (172)   // Panel height (vertical, in pixels)
...
#if !ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
    /* For host */
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_SCK         (GPIO_NUM_10
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA0       (GPIO_NUM_11)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA1       (GPIO_NUM_12)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA2       (GPIO_NUM_13)
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_DATA3       (GPIO_NUM_14)
#endif // ESP_PANEL_BOARD_LCD_BUS_SKIP_INIT_HOST
    /* For panel */
    #define ESP_PANEL_BOARD_LCD_QSPI_IO_CS          (GPIO_NUM_9)     // -1 if not used
    #define ESP_PANEL_BOARD_LCD_QSPI_MODE           (3)     // 0-3, typically set to 0
 ...
 */
    ...
    /* For host */
    #define ESP_PANEL_BOARD_TOUCH_I2C_CLK_HZ            (300000)
    ...
    #define ESP_PANEL_BOARD_TOUCH_I2C_IO_SCL            (GPIO_NUM_48)
    #define ESP_PANEL_BOARD_TOUCH_I2C_IO_SDA            (GPIO_NUM_47)
#endif
    /* For panel */
    #define ESP_PANEL_BOARD_TOUCH_I2C_ADDRESS           (0x3b)     // Typically set to 0 to use the default address.
...
#define ESP_PANEL_BOARD_BACKLIGHT_TYPE          (ESP_PANEL_BACKLIGHT_TYPE_PWM_LEDC)
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_IO        (GPIO_NUM_8)    // Output GPIO pin number
     ...
     */
    #define ESP_PANEL_BOARD_BACKLIGHT_PWM_FREQ_HZ   (50 * 1000)  // LEDC timer frequency.
    ...
    #define ESP_PANEL_BOARD_BACKLIGHT_PWM_DUTY_RESOLUTION  (LEDC_TIMER_8_BIT) // LEDC timer duty resolution.
