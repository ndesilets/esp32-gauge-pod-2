...
static int _volume_intensity = 5;
...
int bsp_extra_codec_volume_get(void) { return _volume_intensity; }
...
bool bsp_extra_player_is_playing_by_path(const char* file_path) { return (strcmp(audio_file_path, file_path) == 0); }
